    ...
    <div class="col-sm-6">
        ...
        <form id="updateForm" class="form-horizontal" action="<?php echo URL; ?>amministratore/update" method="post">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select id="selector" class="form-control" name="old_nome_login">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="email" class="form-control" id="email" placeholder="Inserisci la email" name="email">
                </div>
            </div>
    ...
    <div class="col-sm-6">
        ...
        <form class="form-horizontal" action="amministratore/update" method="post">
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" for="email">Email:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="email" placeholder="Inserisci la email" name="email">
                </div>
            </div>
